...
function mostrar(idusuario){
	$.post("../ajax/usuario.php?op=mostrar",{idusuario : idusuario},
		function(data,status)
		{
            ...
            $("#sueldo_fijo").val(data.sueldo_fijo);
            $("#imagenmuestra").show();
        ...
        "columns": [
            ...
            // Agrega otras columnas según sea necesario
            {
                ...
                render: function (data, type, row) {
                    return '<button class="btn btn-warning" onclick="mostrar(' + row.idusuario + ')">Editar</button> ' +
                           '<button class="btn btn-danger" onclick="eliminar(' + row.idusuario + ')">Eliminar</button>';
                }
            }
        ]
    });
