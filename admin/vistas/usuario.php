...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" pattern="^[A-ZÑa-zñáéíóúÁÉÍÓÚ'° ]+$" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Ej: Juan" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Apellidos(*):</label>
      <input class="form-control" pattern="^[A-ZÑa-zñáéíóúÁÉÍÓÚ'° ]+$" type="text" name="apellidos" id="apellidos" maxlength="100" placeholder="Ej: Pérez" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Usuario App Móvil(*):</label>
...
<!--     <div class="form-group col-lg-6 col-md-6 col-xs-12" id="claves">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12" id="claves">
      <label for="">Clave App Móvil(*):</label>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control filestyle" data-buttonText="Seleccionar foto" type="file" name="imagen" id="imagen" accept="image/png, image/gif, image/jpeg">
      <input type="hidden" name="imagenactual" id="imagenactual">
      <img src="" alt="" width="150px" height="120" id="imagenmuestra">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Sueldo Fijo: </label>
      <input class="form-control" type="float" name="sueldo_fijo" id="sueldo_fijo" maxlength="70" placeholder="sueldo fijo">
    </div>
